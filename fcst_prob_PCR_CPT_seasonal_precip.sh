...
declare -a tgt=('Feb-Apr')#for now, just write the period(s) corresponding a tgti to tgtf (for DL) for each init
#Initial and final years (hindcasts)
iyear=1982
fyear=2010
